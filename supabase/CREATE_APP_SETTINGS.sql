...
VALUES (
  'ai_cost_per_minute',
  '0.15',
  'Cost per minute for AI calls (what you pay Retell). User rate is $0.65/min, so profit = $0.65 - this value per minute.'
)
...
VALUES (
  ...
  '0.65',
  'Rate charged to users per minute of AI calls ($0.65/min)'
)
ON CONFLICT (key) DO NOTHING;
