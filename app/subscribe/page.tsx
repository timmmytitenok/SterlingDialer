        ...
        <div className="flex-1 flex flex-col items-center justify-center px-4 py-6 md:py-12">
          <div className="max-w-7xl w-full">
            ...
            <div className="text-center mb-6 md:mb-12 space-y-3 md:space-y-4">
              ...
              <div className="mt-4 md:mt-6 inline-flex items-start gap-2 md:gap-3 px-4 md:px-6 py-3 md:py-4 bg-yellow-500/10 border border-yellow-500/30 rounded-lg md:rounded-xl max-w-2xl animate-in slide-in-from-bottom duration-700 delay-200">
                ...
                <div className="text-left">
                  <p className="text-xs md:text-sm text-yellow-300 font-semibold mb-1">Subscription Required</p>
                  <p className="text-xs md:text-sm text-yellow-200/80">
                    You'll need to select and activate a subscription plan to access your dashboard and start using Sterling AI.
                  </p>
                </div>
              </div>
            </div>
