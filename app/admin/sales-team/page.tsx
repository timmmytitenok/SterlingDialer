...
export default function SalesTeamPage() {
  ...
  const loadSalesTeam = async () => {
    try {
      ...
      // Calculate stats
      // Total Revenue = sum of all commissions earned (before 35% split)
      ...
      // Revenue generated = commissions / 0.35 (since commission is 35% of subscription)
      const revenueGenerated = totalCommissionsEarned / 0.35;
