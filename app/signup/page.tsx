...
import { Sparkles, Mail, Lock, User, ArrowRight, Zap, CheckCircle, Phone } from 'lucide-react';
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="mb-6 p-4 bg-green-500/10 border border-green-500/30 rounded-xl">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-green-400 font-bold text-sm">30 Days Free — No Charge Today</span>
          </div>
          <p className="text-gray-300 text-xs">
            We'll ask for a card (required), but you won't be charged until after your trial ends.
          </p>
        </div>

        {/* Form Card */}
        <div className="bg-[#1A2647] rounded-2xl p-8 border border-gray-800 shadow-2xl">
          {error && (
          ...
          <form onSubmit={handleSignup} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full px-6 py-4 bg-gradient-to-r from-purple-600 via-indigo-600 to-blue-600 hover:from-purple-500 hover:via-indigo-500 hover:to-blue-500 text-white font-bold text-lg rounded-xl transition-all duration-300 hover:scale-105 shadow-xl hover:shadow-purple-500/50 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {loading ? (
                <>
          ...
          <div className="mt-6 pt-6 border-t border-gray-800">
            <p className="text-xs text-gray-400 mb-3">What happens next:</p>
